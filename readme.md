...
Se till att du har Node.js och npm installerat på din dator. <br/><br/>
Du kan antigen klona ner repot eller ladda ner projektet som ZIP från GitHub och extrahera det. <br/><br/>
Installera beroenden: npm install <br/><br/>
Starta server: npm run dev <br/><br/>
