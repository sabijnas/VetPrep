...
* Se till att du har Node.js och npm installerat på din dator. 
Du kan antigen klona ner repot eller ladda ner projektet som ZIP från GitHub och extrahera det. 
